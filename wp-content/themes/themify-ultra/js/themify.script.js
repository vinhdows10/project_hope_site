...
(function ($) {
    ...
    $(function() {
        ...
        function themeScrollTo(offset) {
            ...
            Themify.scrollTo(offset,800,function(){
                 if ('undefined' !== typeof Rellax && 'function' === typeof Rellax.enableCheckPosition) {
                    if(timeout!==null){
                        clearTimeout(timeout);
                    }
                    timeout = setTimeout(Rellax.enableCheckPosition, 1000);
                }
            });
        }
        ...
        if (themifyScript.shop_masonry === 'yes') {
                Themify.isoTop('.woocommerce.archive #content ul.products',{layoutMode:'fitRows', itemSelector: '.product'});
        }
