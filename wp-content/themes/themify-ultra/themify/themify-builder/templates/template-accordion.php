            ...
            foreach ($content_accordion as $i=>$content):
                ...
                <li<?php if ($content['default_accordion'] === 'open'):?> class="builder-accordion-active"<?php endif;?> aria-expanded="<?php echo ($content['default_accordion'] === 'open')? "true" : "false" ; ?>">
                    <div class="accordion-title">
                        <a href="#acc-<?php echo $element_id . '-' . $i; ?>">
			    ...
			    <span class="tb_title_accordion"<?php if(Themify_Builder::$frontedit_active===true):?> contenteditable="false" data-repeat="content_accordion" data-name="title_accordion" data-index="<?php echo $i?>"<?php endif;?>><?php echo $content['title_accordion']; ?></span>
                    ...
                    <div id="acc-<?php echo $element_id . '-' . $i; ?>" class="accordion-content clearfix <?php if ($content['default_accordion'] !== 'open'): ?> default-closed<?php endif; ?>">
