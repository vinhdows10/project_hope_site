...
c=null;c=r["builderdata_"+e]?r["builderdata_"+e].data:[];c=Array.isArray(c)&&0!==c.length?c.filter(function(a){return 0<Object.keys(a).length}):{};r["builderdata_"+e]=null;f.id=e;f.Instances.Builder[f.builderIndex]=new f.Views.Builder({el:a,collection:new f.Collections.Rows(c),type:f.mode});f.Instances.Builder[f.builderIndex].render();c=null;f.bootstrap(null,function(){ThemifyStyles.init(ThemifyConstructor.data,ThemifyConstructor.breakpointsReverse,e);f.liveStylingInstance=new N;f.liveStylingInstance.setCss(f.Mixins.Builder.toJSON(f.Instances.Builder[0].el));
