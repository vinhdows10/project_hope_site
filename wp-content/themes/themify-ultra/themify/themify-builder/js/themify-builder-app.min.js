...
h.model.get("mod_settings");d?d.hasClass("tb_module_front")?d.after(l.el):d.append(l.el):a.replaceWith(l.el);k?b.activeModel=h.model:h.model.trigger("edit",null);b.hasChanged=!0;if("visual"===b.mode&&"layout-part"!==h.model.get("mod_name")&&1<=Object.keys(e).length){var f=e.cid;if("part"===g||"ajax"===a.data("type")){var m=!0;h.model.trigger("custom:preview:refresh",e)}else"module"!==g?h.model.trigger("custom:preview:live",e):b.Utils.loadContentJs(l.$el,"module")}k&&(m&&(m=h.view.$el.find(".tb_preview_component").detach(),
h.view.$el.prepend(m)),c&&(f=l.$el.closest(".module_row"),f.removeClass("tb_row_empty").find(".tb_module_dragging_helper").remove(),l.$el.closest(".module_subrow").removeClass("tb_row_empty"),b.undoManager.push(f.data("cid"),c,f,"row"),f=f.data("cid"),b.Instances.Builder[b.builderIndex].removeLayoutButton(),b.activeModel=null),b.Utils.calculateHeight());b.Utils.scrollToDropped(null,f)}var h=b.Views.init_module(e,!0),l=h.view.render();"visual"===b.mode&&k?(e=[],e[h.model.cid]=1,b.bootstrap(e,f)):f(!0);
return l}b.ActionBar.clear();if(a[0].classList.contains("tb_row_grid"))this.subRowDrop(a.data("slug"),a);else{var f={mod_name:a.data("module-slug")},g=a.data("type"),k="part"===g||"module"===g;if(k)b.toolbar.libraryItems.get(a.data("id"),g,e);else return e(f);"visual"!==b.mode&&h(".themify-wp-editor-holder").addClass("themify-active-holder")}},toJSON:function(a){var d=[];a=a.children;for(var c=0,e=a.length;c<e;++c)if(a[c].classList.contains("module_row")){var f=b.Utils._getRowSettings(a[c]);0<Object.keys(f).length&&
d.push(f)}return d},columnHover:function(a){for(var d=a.closest(".sub_column"),c=b.Instances.Builder[b.builderIndex].el.getElementsByClassName("tb_hover_sub_column"),e=c.length-1;-1<e;--e)c[e].classList.remove("tb_hover_sub_column");c=b.Instances.Builder[b.builderIndex].el.getElementsByClassName("tb_action_overlap");for(e=c.length-1;-1<e;--e)c[e].classList.remove("tb_action_overlap");if(null!==d){var f=d.parentNode.closest(".module_column");if(!f.classList.contains("tb_hover_sub_column")&&(f.classList.add("tb_hover_sub_column"),
c=d.getElementsByClassName("tb_column_action")[0],c!==r)){var e=c.getBoundingClientRect(),g=!0,f=5>e.left?f.closest(".module_row").getElementsByClassName("tb_row_action")[0]:d.closest(".module_subrow").getElementsByClassName("tb_subrow_action")[0];f!==r&&(g=f.getBoundingClientRect(),g=Math.abs(e.left-g.left)<e.width?Math.abs(g.top-e.top)>e.height:!0);!0===g?c.classList.remove("tb_action_overlap"):c.classList.add("tb_action_overlap")}}!0!==this.isFullWidth&&(d=null!==d?d.parentNode.closest(".module_column"):
a.closest(".module_column"),!1!==this.isFullWidth&&(a=null!==d?d.closest(".module_row"):a.closest(".module_row"),null!==a&&(a.offsetWidth<q.body.clientWidth?(this.isFullWidth=!0,q.body.classList.remove("tb_page_row_fullwidth")):(this.isFullWidth=!1,q.body.classList.add("tb_page_row_fullwidth")))),null!==d&&null!==d.parentNode.parentNode.closest(".fullwidth")&&(a=d.getElementsByClassName("tb_column_action")[0],a!==r&&a.getBoundingClientRect().right>=q.body.clientWidth&&a.classList.add("tb_action_outside")))}};
b.undoManager={stack:[],is_working:!1,index:-1,btnUndo:null,btnRedo:null,compactBtn:null,init:function(){this.btnUndo=b.toolbar.el.getElementsByClassName("tb_undo_btn")[0];this.btnRedo=b.toolbar.el.getElementsByClassName("tb_redo_btn")[0];this.compactBtn=b.toolbar.el.getElementsByClassName("tb_compact_undo")[0];b.toolbar.$el.find(".tb_undo_redo").on("click",this.do_change.bind(this));if(!themifyBuilder.disableShortcuts&&(h(u.document).on("keydown",this.keypres.bind(this)),"visual"===b.mode))h(q).on("keydown",
this.keypres.bind(this))},push:function(a,d,c,e,f){b.hasChanged&&(b.editing=!1,c&&(c=n.clone(c)),"visual"!==b.mode||"duplicate"!==e&&"sort"!==e||h(x).triggerHandler("tfsmartresize.tfVideo"),this.stack.splice(this.index+1,this.stack.length-this.index),this.stack.push({cid:a,type:e,data:f,before:d,after:c}),this.index=this.stack.length-1,this.updateUndoBtns(),"visual"===b.mode&&(b.Forms.LayoutPart.isSaved=null,v.body.triggerHandler("builder_dom_changed",[e])))},set:function(a){var d=a[0].querySelectorAll("[data-cid]"),
d=Array.prototype.slice.call(d);d.unshift(a[0]);a=0;for(var c=d.length;a<c;++a){var e=b.Models.Registry.lookup(d[a].getAttribute("data-cid"));e&&e.trigger("change:view",d[a])}},doScroll:function(a){return a},keypres:function(a){if(90===a.which&&"INPUT"!==q.activeElement.tagName&&"TEXTAREA"!==q.activeElement.tagName)if(!0===a.ctrlKey&&!0===a.shiftKey||!0===a.metaKey&&!0===a.shiftKey)a.preventDefault(),this.hasRedo()&&this.changes(!1);else if(!0===a.ctrlKey||!0===a.metaKey)a.preventDefault(),this.hasUndo()&&
this.changes(!0)},changes:function(a){b.ActionBar.clearClicked();var d=a?0:1;if(null!==b.activeModel){if(!0===b.hasChanged){ThemifyConstructor.saveComponent(!1);h(this.btnUndo).triggerHandler("click");return}n.Lightbox.close()}var c=this.stack[this.index+d];if(c!==r){this.is_working=!0;var e="";var f=c.type;var g=h(".tb_element_cid_"+c.cid);d=!1;b.eventName=f;if("row"===f)a?(e=n.clone(c.before),d=c.cid):(e=n.clone(c.after),d=c.before.data("cid"),g=h(".tb_element_cid_"+d)),this.doScroll(g),this.set(e),
e.toggleClass("tb_row_empty",0===e.find(".active_module").length),g.replaceWith(e);else if("duplicate"===f)a?this.doScroll(h(".tb_element_cid_"+c.after.data("cid"))).remove():(this.doScroll(g),e=n.clone(c.after),d=c.before.data("cid"),this.set(e),g.after(e));else if("delete_row"===f)a?(e=n.clone(c.before),d=c.cid,g=h(".tb_element_cid_"+c.data.pos_cid),this.doScroll(g),this.set(e),"after"===c.data.pos?g.after(e):g.before(e)):this.doScroll(g).remove();else if("sort"===f)d=c.cid,a?(g=c.data.before,e=
n.clone(c.before)):(g=c.data.after,e=n.clone(c.after),"visual"===b.mode&&e.find(".active_module").css({display:"block",height:"auto"})),this.doScroll(e),this.set(e),c=h(".tb_element_cid_"+d).closest(".module_row"),h(".tb_element_cid_"+d).remove(),c.toggleClass("tb_row_empty",0===c.find(".active_module").length),c=null,h(".tb_element_cid_"+g).replaceWith(e),c=e.closest(".module_row"),c.toggleClass("tb_row_empty",0===c.find(".active_module").length),c=null;else if("row_sort"===f){d=c.cid;var k=c.data[a?
"bnext":"anext"];c=h(".tb_element_cid_"+c.data[a?"before":"after"]);g=h(".tb_element_cid_"+d);e=n.clone(g);g.remove();g=null;this.set(e);k?c.before(e):c.after(e);this.doScroll(e)}else if("save"===f){d=c.cid;var f=b.Models.Registry.lookup(d),l="module"===f.get("elType"),m=l?"mod_settings":"styling";if(l&&c.data.column)a?(c=h(".tb_element_cid_"+d).closest(".module_row"),d=!1,this.doScroll(g).remove()):(d=c.data.column.data("cid"),e=n.clone(c.data.column),g=h(".tb_element_cid_"+d),this.doScroll(g),this.set(e),
g.replaceWith(e),c=e.closest(".module_row")),c.toggleClass("tb_row_empty",0===c.find(".active_module").length),c=null;else{this.doScroll(g);l={};a?(e=n.clone(c.before),l[m]=c.data.bsettings):(e=n.clone(c.after),l[m]=c.data.asettings);if("visual"===b.mode){c=h.extend(!0,{},c.data.styles);for(var t in c){var p=ThemifyStyles.getSheet(t),p=p.cssRules?p.cssRules:p.rules;for(k in c[t])if(p[k])for(var y in c[t][k])p[k].style["backgroundClip"===y||"background-clip"===y?"WebkitBackgroundClip":y]=a?c[t][k][y].b:
c[t][k][y].a}c=b.activeModel;k=l[m][b.GS.key]!==r?l[m][b.GS.key].split(" "):[];b.activeModel=f;b.GS.liveInstance=null;b.GS.generateValues(null,k,!0);b.activeModel=c;b.GS.liveInstance=null}f.set(l,{silent:!0});l=null;this.set(e);g.replaceWith(e)}}else if("predesign"===f)if(g=c.data.rows,a)for(this.doScroll(h(".tb_element_cid_"+g[0].data("cid"))),k=0,f=g.length;k<f;++k)h(".tb_element_cid_"+g[k].data("cid")).remove();else{t=q.createDocumentFragment();e=[];k=0;for(f=g.length;k<f;++k)y=n.clone(g[k]),t.appendChild(y[0]),
e.push(y);!1!==c.data.prev?this.doScroll(h(".tb_element_cid_"+c.data.prev)).after(t):this.doScroll("visual"===b.mode?h("#themify_builder_content-"+c.data.bid):h("#tb_row_wrapper")).prepend(t);k=0;for(f=e.length;k<f;++k)this.set(e[k]),b.Mixins.Builder.update(e[k])}else if("import"===f){g=h('[data-postid="'+c.data.bid+'"]');c=a?c.data.before:c.data.after;var w=this;c=n.clone(c);g.children().remove();g.prepend(c);c.each(function(){w.set(h(this))})}else"grid_sort"===f&&(a?h(".tb_element_cid_"+c.cid).remove():
(g=h(".tb_element_cid_"+c.before),e=n.clone(c.after),d=c.cid,c.data.next?g.before(e):g.after(e),this.set(e)));d&&(b.ActionBar.hoverCid=null,b.Mixins.Builder.update(h(e)));a?--this.index:++this.index;this.is_working=!1;this.updateUndoBtns();b.toolbar.pageBreakModule.countModules();b.Utils.calculateHeight()}},hasRedo:function(){return this.index<this.stack.length-1},hasUndo:function(){return-1!==this.index},disable:function(){this.btnUndo.classList.add("tb_disabled");this.btnRedo.classList.add("tb_disabled");
this.compactBtn.classList.add("tb_disabled")},updateUndoBtns:function(){var a=this.hasUndo(),b=this.hasRedo();a?this.btnUndo.classList.remove("tb_disabled"):this.btnUndo.classList.add("tb_disabled");b?this.btnRedo.classList.remove("tb_disabled"):this.btnRedo.classList.add("tb_disabled");a||b?this.compactBtn.classList.remove("tb_disabled"):this.compactBtn.classList.add("tb_disabled")},reset:function(){this.stack=[];this.index=-1;this.updateUndoBtns()},do_change:function(a){a.preventDefault();a.stopPropagation();
!1!==this.is_working||a.currentTarget.classList.contains("tb_disabled")||this.changes(a.currentTarget.classList.contains("tb_undo_btn"))}};b.Views.Toolbar=z.View.extend({events:{"click .tb_import":"import","click .tb_load_layout":"loadLayout","click .tb_save_layout":"saveLayout","click .tb_dup_link":"duplicate","click .tb_toolbar_save":"save","click .tb_toolbar_backend_edit a":"save","click .tb_toolbar_close_btn":"panelClose","click .tb_breakpoint_switcher":"breakpointSwitcher","click .tb_popular_devices li":"deviceSwitcher",
"change .tb_change_mode input":"modChange","click .tb_float_minimize":"minimize","click .tb_float_close":"closeFloat","click .tb_toolbar_add_modules":"openFloat","click .tb_custom_css":"addCustomCSS","click .tb_zoom":"zoom","click .tb_toolbar_zoom_menu_toggle":"zoom","click .tb_toolbar_builder_preview":"previewBuilder","click .js-tb_module_panel_acc":"toggleAccordion"},lightboxStorageKey:"tb_module_panel",render:function(){var a=this,d={},c;for(c in themifyBuilder.modules){var e=q.createElement("div");
var f=q.createElement("div");var g=q.createElement("span"),h=q.createElement("strong"),l=q.createElement("a");e.className="tb_module_outer tb-module-"+c;e.dataset.categories=themifyBuilder.modules[c].category;themifyBuilder.modules[c].favorite&&(e.className+=" favorited");f.className="tb_module tb-module-type-"+c;g.className="tb_favorite ti-star tb_disable_sorting";h.className="module_name";h.textContent=themifyBuilder.modules[c].name;l.href="#";l.className="add_module_btn tb_disable_sorting";l.dataset.type=
"module";l.title=themifyBuilder.i18n.add_module;f.dataset.moduleSlug=c;themifyBuilder.modules[c].type&&(f.dataset.type=themifyBuilder.modules[c].type);f.appendChild(g);f.appendChild(h);f.appendChild(l);e.appendChild(f);f=themifyBuilder.modules[c].favorite?["favorite"]:themifyBuilder.modules[c].category;g=0;for(h=f.length;g<h;++g)d[f[g]]===r&&(d[f[g]]=q.createDocumentFragment()),d[f[g]].appendChild(e.cloneNode(!0))}f=this.el.getElementsByClassName("tb_module_category_content");for(c=f.length-1;-1<
c;--c)if(e=f[c].getAttribute("data-category"))r!==d[e]?f[c].appendChild(d[e]):f[c].parentNode.style.display="none";f=null;"visual"===b.mode&&u.document.body.appendChild(this.el);d=function(){a.Panel.init();b.undoManager.init();new SimpleBar(a.el.getElementsByClassName("tb_module_panel_modules_wrap")[0]);a.pageBreakModule.init();a.preDesignedRows.init();a.libraryItems.init();a.common.init();setTimeout(function(){a.setMode();a.help.init();setTimeout(function(){a.Revisions.init()},1200);"visual"===b.mode&&
(b.Mixins.Builder.initModuleVisualDrag(".tb_module"),b.Mixins.Builder.initRowGridVisualDrag())},800);"visual"===b.mode&&(a.$el.on("click",".tb_favorite",a.toggleFavoriteModule),a.unload());v.body.on("click",".tb_favorite",a.toggleFavoriteModule);a.draggable();"true"===localStorage.getItem("tb_panel_closed")?a.closeFloat():a.Panel.setFocus()};if("visual"===b.mode)u.jQuery("body").one("themify_builder_ready",d);else d()},setMode:function(){localStorage.getItem("tb_mode")?b.ActionBar.isHoverMode=null:
(b.ActionBar.isHoverMode=!0,this.el.getElementsByClassName("tb_change_mode")[0].getElementsByClassName("tb-checkbox")[0].checked=!0);!0===b.ActionBar.isInit&&b.ActionBar.changeMode()},modChange:function(a){a.stopPropagation();a.currentTarget.classList.contains("tb_mode")?(!0===a.currentTarget.checked?(localStorage.removeItem("tb_mode"),b.ActionBar.isHoverMode=!0):(localStorage.setItem("tb_mode",1),b.ActionBar.isHoverMode=null),b.ActionBar.clear(),b.ActionBar.clearClicked(),b.ActionBar.clearSelected(),
...
a();else{k[0].classList.add("tb_predesigned_lightbox");this.setStandAlone(u.innerWidth/2,(u.document.documentElement.clientHeight-k.height())/2,!0);var m=l.find(".tb_ui_dropdown_items"),t=function(a){a.each(function(a){0===a%4?this.classList.add("layout-column-break"):this.classList.remove("layout-column-break")})};if(d.layoutsList)g();else{var p=function(a,b){for(var c={},e=q.createDocumentFragment(),f=q.createDocumentFragment(),p=0,y=a.length;p<y;++p){var n=q.createElement("li"),w=q.createElement("div"),
u=q.createElement("div"),v=q.createElement("img"),x=q.createElement("div"),B=q.createElement("div");n.className="layout_preview_list";n.dataset.category=a[p].category;w.className="layout_preview";w.dataset.id=a[p].id;w.dataset.slug=a[p].slug;u.className="thumbnail";v.src=a[p].thumbnail;v.alt=a[p].title;v.title=a[p].title;x.className="layout_action";B.className="layout_title";B.textContent=a[p].title;x.appendChild(B);if(r!==a[p].url){var B=q.createElement("a"),z=q.createElement("i");B.className="layout-preview-link themify_lightbox";
B.href=a[p].url;B.target="_blank";B.title=themifyBuilder.i18n.preview;z.className="ti-search";B.appendChild(z);x.appendChild(B)}u.appendChild(v);w.appendChild(u);w.appendChild(x);n.appendChild(w);e.appendChild(n);if(a[p].category)for(n=String(a[p].category).split(","),w=0,u=n.length;w<u;++w)""!==n[w]&&1!==c[n[w]]&&(v=q.createElement("li"),v.textContent=n[w],f.appendChild(v),c[n[w]]=1,n[w]===b&&(v.className="tb_selected_cat"))}m[0].appendChild(f);l[0].getElementsByClassName("tb_layout_lists")[0].appendChild(e);
...
0,f=Object.keys(this.items),g=f.length,h=0;h<g&&!(10<=e&&r==a);h++){var l=this.items[f[h]],m=""!==a?new RegExp(a,"i"):!1;if(m&&m.test(l.title)){var t=l.category.split(",");if("All"===b||-1!==t.indexOf(b)){delete this.items[f[h]];for(var m="",p=0,n=t.length;p<n;++p)m+=this.categories[t[p]].hash;var t=q.createElement("div"),p=q.createElement("figure"),n=q.createElement("div"),w=new Image,u=q.createElement("a");t.className="predesigned_row "+m;t.setAttribute("data-slug",l.slug);p.className="tb_predesigned_rows_image";
n.className="tb_predesigned_rows_title";n.textContent=w.alt=w.title=l.title;w.src=l.thumbnail===r||""===l.thumbnail?"https://placeholdit.imgix.net/~text?txtsize=24&txt="+encodeURI(l.title)+"&w=181&h=77":l.thumbnail;w.width=500;w.height=300;u.href="#";u.className="add_module_btn tb_disable_sorting";u.dataset.type="predesigned";p.appendChild(w);p.appendChild(u);t.appendChild(p);t.appendChild(n);c.appendChild(t);++e}}}this.categories[b].isLoaded=10>e&&r===a;return c},setData:function(a){this.items=a;
...
"block";h(this).find(".tb_module_outer:visible").length||(this.parentElement.style.display="none")})}},clear:function(a){a.preventDefault();a.stopPropagation();a=h(this).parent().children("input").first();0<a.length&&(a.val(""),a[0].hasAttribute("data-search")?a.trigger("keyup").focus():(a.trigger("change"),v.triggerEvent(a[0],"change")))}},help:{init:function(){h(".tb_help_btn",b.toolbar.$el).on("click",this.show.bind(this))},show:function(a){a.preventDefault();a.stopPropagation();var b=this;n.showLoader("show");
return h.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{tb_load_nonce:themifyBuilder.tb_load_nonce,action:"tb_help"},complete:function(){n.showLoader("spinhide")},success:function(a){u.document.body.insertAdjacentHTML("beforeend",a);a=h("#tb_help_lightbox",u.document.body);h(".tb_help_tab_link",a).on("click",b.mainTabs.bind(b));h(".tb_player_btn",a).on("click",b.play.bind(b));h(".tb_help_menu a",a).on("click",b.tabs.bind(b));h(".tb_close_lightbox",a).on("click",b.close.bind(b));a.slideDown()}})},
play:function(a){a.preventDefault();a.stopPropagation();a=h(a.currentTarget).closest("a");var b=a.prop("href"),c=q.createElement("iframe");c.setAttribute("frameborder","0");c.setAttribute("allow","autoplay; fullscreen");c.setAttribute("src",b+"?rel=0&showinfo=0&autoplay=1&enablejsapi=1&html5=1&version=3");a.replaceWith(c)},tabs:function(a){a.preventDefault();a.stopPropagation();a=h(a.currentTarget);var b=h(".tb_help_video_wrapper",u.document),c=b.find(a.attr("href")),e=c.find(".tb_player_btn");b.find(".tb_player_wrapper").removeClass("current").hide();
c.addClass("current").show();a.closest("li").addClass("current").siblings().removeClass("current");this.stopPlay();0<e.length?e.trigger("click"):this.startPlay()},execute:function(a,b){a.contentWindow.postMessage('{"event":"command","func":"'+b+'","args":""}',"*")},stopPlay:function(){var a=this;h(".tb_player_wrapper",u.document).each(function(){if(!this.classList.contains("current")){var b=h(this).find("iframe");0<b.length&&a.execute(b[0],"pauseVideo")}})},startPlay:function(){var a=h(".tb_player_wrapper.current",
u.document).find("iframe");0<a.length&&this.execute(a[0],"playVideo")},close:function(a,b){a.preventDefault();a.stopPropagation();h(a.currentTarget).closest("#tb_help_lightbox").slideUp("normal",function(){h(this).next(".tb_overlay").remove();h(this).empty().remove();b&&b()})},mainTabs:function(a){a.preventDefault();a.stopPropagation();a=h(a.currentTarget);var b=h(".tb_help_lightbox_inner_wrapper",u.document);a.hasClass("tb_help_active_tab")||(b.find(".tb_help_active_tab").removeClass("tb_help_active_tab"),
a.addClass("tb_help_active_tab"),b.attr("data-active-tab",a.data("type")))}},deviceSwitcher:function(a){var b=a.target,c=b.parentNode.previousElementSibling;c.classList.contains("tb_breakpoint_switcher")&&(a.tb_device=[b.dataset.width,b.dataset.height],a.target=c,a.currentTarget=c,this.breakpointSwitcher(a))},breakpointSwitcher:function(a){a.preventDefault();a.stopPropagation();var d=this,c="desktop",e=a.currentTarget,f=h("body",u.document),g="visual"===b.mode&&b.iframe[0].classList.contains("tb_resizing_start"),
k=b.activeBreakPoint,l=function(){d.responsive_grids(c,k);var a=function(){b.Utils.setCompactMode(q.getElementsByClassName("module_column"));b.toolbar.el.getElementsByClassName("tb_compact_switcher")[0].getElementsByTagName("i")[0].className=e.getElementsByTagName("i")[0].className;f.removeClass("tb_start_animate").toggleClass("tb_responsive_mode","desktop"!==c).removeClass("builder-breakpoint-"+k).addClass("builder-breakpoint-"+c);v.body.triggerHandler("themify_builder_change_mode",[k,c]);"visual"===
b.mode&&(b.iframe[0].style.willChange="",setTimeout(function(){"desktop"!==b.activeBreakPoint?b.Utils.calculateHeight():u.document.body.style.height="";!g&&b.scrollTo&&(h(x).add(u.document).scrollTop(b.scrollTo.offset().top),b.scrollTo=!1)},150));b.ActionBar.disable=b.clearOnModeChange=null};"visual"===b.mode?b.Utils._onResize(!0,function(){d.iframeScroll("desktop"!==c);"desktop"!==k&&"desktop"!==c||b.Mixins.Builder.updateModuleSort(null,"desktop"===c?"enable":"disable");b.ActionBar.hoverCid=null;
b.EdgeDrag.clearEdges();setTimeout(a,g?1:100)}):a()};e.classList.contains("breakpoint-tablet")?c="tablet":e.classList.contains("breakpoint-tablet_landscape")?c="tablet_landscape":e.classList.contains("breakpoint-mobile")&&(c="mobile");if(r!==a.tb_device||!v.body[0].classList.contains("builder-breakpoint-"+c)){var m="desktop"!==c?r!==a.tb_device?"tablet_landscape"===c?a.tb_device[1]:a.tb_device[0]:b.Utils.getBPWidth(c)-1:"";if(k===c&&a.originalEvent!==r&&(m?m+"px":m)===b.iframe[0].style.width)return!1;
b.ActionBar.disable=!0;if("visual"===b.mode){null===b.clearOnModeChange&&b.ActionBar.clear();if(!g&&!b.isPreview){var t=b.Instances.Builder[0].el.children;var p=[];for(var y=x.innerHeight,w=function(a){if(null!==a&&a!==r){var b=a.getBoundingClientRect();if(0>b.bottom&&0>b.top||b.top>y)a.style.display="none",p.push(a)}},E=t.length-1;-1<E;--E)w(t[E]);w(q.getElementById("headerwrap"));w(q.getElementById("footerwrap"));t=y=null}f=f.add(v.body)}b.activeBreakPoint=c;f.addClass("tb_start_animate");if("visual"===
b.mode){b.iframe[0].style.willChange="width";t=u.document.getElementsByClassName("tb_toolbar_zoom_menu")[0];t.classList.remove("tb_toolbar_zoom_active");t.getElementsByClassName("tb_toolbar_zoom_menu_toggle")[0].dataset.zoom=100;"tablet_landscape"===c&&n.Lightbox.dockMode.get()&&(t=h(".tb_workspace_container",u.document).width(),t<m&&(m=t));if(b.isPreview&&(t={tablet_landscape:[1024,768],tablet:[768,1024],mobile:[375,667]},t[c]!==r)){m=r===a.tb_device?t[c][0]:"tablet_landscape"===c?a.tb_device[1]:
a.tb_device[0];var H=r===a.tb_device?t[c][1]:"tablet_landscape"===c?a.tb_device[0]:a.tb_device[1]}b.iframe[0].parentNode.classList.remove("tb_zoom_bg");g?l():(u.document.body.offsetHeight,b.iframe.one(b.Utils.transitionPrefix(),function(){if(!b.isPreview){for(var a=p.length-1;-1<a;--a)p[a].style.display="";p=null}setTimeout(l,10)}),b.iframe[0].style.width=m?m+"px":m,b.iframe[0].style.height=b.isPreview?H?H+"px":H:"")}else l()}},iframeScroll:function(a){var b=h(u.document);b.off("scroll.themifybuilderresponsive");
if(a)b.on("scroll.themifybuilderresponsive",function(){x.scrollTo(0,h(this).scrollTop())})},responsive_grids:function(a,b){for(var c=q.querySelectorAll(".row_inner,.subrow_inner"),d="desktop"===a,f=d||"desktop"===b,g=c.length-1;-1<g;--g){var k=c[g].getAttribute("data-basecol");if(null!==k){var l=c[g].children,m=c[g].dataset["col_"+a],t=l[0],p=l[l.length-1];if(!d){if("desktop"!==b){c[g].classList.remove("tb_3col");var n=c[g].getAttribute("data-col_"+b);n&&c[g].classList.remove(h.trim(n.replace("tb_3col",
"").replace("mobile","column").replace("tablet","column")))}if(m&&"-auto"!==m&&m!==a+"-auto"){if(m=c[g].getAttribute("data-col_"+a))for(c[g].classList.add("tb_grid_classes"),c[g].classList.add("col-count-"+k),m=m.split(" "),k=0,n=m.length;k<n;++k)c[g].classList.add(h.trim(m[k].replace("mobile","column").replace("tablet","column")))}else c[g].classList.remove("tb_grid_classes"),c[g].classList.remove("col-count-"+k)}if(f)for(k=0,m=l.length;k<m;++k)n=h(l[k]).data("w"),n!==r&&(l[k].style.width=d?n+"%":
"");"rtl"===c[g].getAttribute("data-"+a+"_dir")?(t.classList.remove("first"),t.classList.add("last"),p.classList.remove("last"),p.classList.add("first"),c[g].classList.add("direction-rtl")):(t.classList.remove("last"),t.classList.add("first"),p.classList.remove("first"),p.classList.add("last"),c[g].classList.remove("direction-rtl"))}}},Panel:{el:null,init:function(){this.el=b.toolbar.$el.find(".tb_toolbar_add_modules_wrap");this.el.on("click",".add_module_btn",this.initEvents.bind(this));this.compactToolbar();
"visual"===b.mode&&n.Lightbox.dockMode.setDoc()},initEvents:function(a){a.preventDefault();a.stopPropagation();var d=a.currentTarget.dataset.type;"module"===d?this.add_module(a):"row"===d?this.click_add_sub_row(a):"page_break"===d?this.click_add_page_break(a):"predesigned"===d&&b.toolbar.preDesignedRows.get(a.currentTarget.closest(".predesigned_row").dataset.slug,function(a){var c=b.Instances.Builder[b.builderIndex].$el.find(".module_row").last();b.Mixins.Builder.rowDrop(a,h("<div>").insertAfter(c),
!0)})},setFocus:function(){b.toolbar.el.getElementsByClassName("tb_module_panel_search_text")[0].focus()},add_module:function(a,d){a.preventDefault();a.stopPropagation();d&&0!==d.length||(d=b.Instances.Builder[b.builderIndex].newRowAvailable(1,!0).find(".tb_holder").first());b.Mixins.Builder.moduleDrop(h(a.currentTarget).closest(".tb_module"),d)},click_add_sub_row:function(a,d){a.preventDefault();a.stopPropagation();var c=d?!0:!1;d=d||b.Instances.Builder[b.builderIndex].$el.find(".module_row").last();
...
snap:!1,containment:".row_inner",helper:function(b){a=h(b.currentTarget);c=a.closest(".subrow_inner");0===c.length&&(c=a.closest(".row_inner"));q=a[0].classList.contains("tb_drag_right")?"w":"e";z="w"===q?"tb_grid_drag_right_tooltip":"tb_grid_drag_left_tooltip";x=n.clone(c.closest(".module_row"));c.addClass("tb_drag_column_start");return h('<div class="ui-widget-header tb_grid_drag_tooltip '+z+'"></div><div class="ui-widget-header tb_grid_drag_tooltip"></div>')},start:function(f,h){b.ActionBar.disable=
!0;b.ActionBar.clear();d=c.children(".module_column");e=a.closest(".module_column");A=c[0].classList.contains("direction-rtl");"w"===q?(r=A?e.prev(".module_column"):e.next(".module_column"),g=a.outerWidth(),B=e.outerWidth()):(r=A?e.next(".module_column"):e.prev(".module_column"),B=g=e.outerWidth());g=parseInt(g);u=parseInt(r.outerWidth())-2;G=c.outerWidth();C=e.addClass("tb_drag_column_current").children("."+z)[0];I=e.children(".tb_grid_drag_tooltip").last()[0]},stop:function(a,n){h(".tb_grid_drag_tooltip").remove();
c.removeClass("tb_drag_column_start");var p=Math.ceil(100*(e.outerWidth()/G));e.removeClass("tb_drag_column_current").css("width",p+"%");var t=k,p=3.2;c[0].classList.contains("gutter-narrow")?(t=l,p=1.6):c[0].classList.contains("gutter-none")&&(t=m,p=0);var w=p*(d.length-1);d.each(function(a){a!==r.index()&&(h(this).prop("style").width?a=parseFloat(h(this).prop("style").width):(a=h.trim(f.filterClass(h(this).attr("class")).replace("first","").replace("last","")),a=t[a]),w+=a)});r.css("width",100-
w+"%");r=r.add(e);f.setCompactMode(r);var p=c.closest(".module_row"),y=!0===b.hasChanged;b.hasChanged=!0;b.undoManager.push(p.data("cid"),x,p,"row");b.hasChanged=y;v.body.triggerHandler("tb_grid_changed",[p]);setTimeout(function(){b.ActionBar.disable=null},5);C=I=g=u=G=B=r=z=e=q=A=c=d=null},drag:function(a,b){if(r&&0<r.length){var c=parseInt(b.position.left),c=g+("e"===q?-c:c),d=parseFloat(100*c/G);if(5<=d&&100>d){var f=u,f=f+("w"===q?-(c-B):B-c),h=parseFloat(100*f/G);5<h&&100>h&&(r.css("width",f+
"px"),e.css("width",c+"px"),C.innerHTML=d.toFixed(2)+"%",I.innerHTML=h.toFixed(2)+"%")}}}})})}},grid:function(a){var b=[];a=parseInt(a);if(1===a)b.push({grid_class:"col-full"});else for(var c=0;c<a;++c)b.push({grid_class:"col"+a+"-1"});return[{cols:b}]},setCompactMode:function(a){a instanceof jQuery&&(a=a.get());for(var b=a.length-1;-1<b;--b)185>a[b].clientWidth?a[b].classList.add("compact-mode"):a[b].classList.remove("compact-mode")},initNewEditor:function(a){if(3<parseInt(tinyMCE.majorVersion)){var b=
tinyMCEPreInit.mceInit.tb_lb_hidden_editor;b.elements=a;b.selector="#"+a;a=new tinyMCE.Editor(a,b,tinyMCE.EditorManager);a.render();return a}},initQuickTags:function(a){"function"===typeof u.QTags&&(u.quicktags({id:a}),u.QTags._buttonsInit())},_getColClass:function(a){for(var b=0,c=a.length;b<c;++b)if(-1!==this.gridClass.indexOf(a[b]))return a[b].replace("col","")},saveBuilder:function(a,d,c){d=d||0;if(0===d){if(null!==b.activeModel||0<n.Lightbox.$lightbox.length&&n.Lightbox.$lightbox[0].classList.contains("tb_custom_css_lightbox")){var e=
n.Lightbox.$lightbox[0].getElementsByClassName("builder_save_button")[0];e!==r&&e.click();e=null}n.showLoader("show")}var f=Object.keys(b.Instances.Builder).length,g=b.Instances.Builder[d],k=this,e=g.$el.data("postid"),g=b.Mixins.Builder.toJSON(g.el);if(!0===c)return{id:e,data:g};b.GS.setImport(b.GS.styles,null,null,!0);(function(a,c){var d={action:"tb_save_data",tb_load_nonce:themifyBuilder.tb_load_nonce,id:a,custom_css:A,sourceEditor:"visual"===b.mode?"frontend":"backend"};k.saveCss(c,d.custom_css,
...
null!==b.activeModel&&b.ActionBar.cid===b.activeModel.cid,k=!n.Lightbox.$lightbox[0].contains(this),l="hide_anchor"!==d?this.id:"hide_anchor",m="custom_css_id"===l,t=!0!==m||!1!==k&&!0!==f?r:n.Lightbox.$lightbox[0].getElementsByClassName("builder_save_button")[0];var p=!0===k&&!1===f?h(".tb_element_cid_"+b.ActionBar.cid):"visual"===b.mode?b.liveStylingInstance.$liveStyledElmt:h(".tb_element_cid_"+b.activeModel.cid);var u=!1===f&&!0===k?n.clone(p[0]):null;var w=this.value;"keyup"===c&&"custom_css"!==
d?((w=w.trim())&&(w=w.replace(/[^a-zA-Z0-9\-\_]+/gi,"")),this.value=w):"layout"===d?w=a.detail.val:"hide_anchor"===d&&(w=this.checked?"1":"0");if(e[d].call(e,this,l,p,w)){m&&(h(this).next(".tb_field_error_msg").remove(),t!==r&&t.classList.remove("tb_disable_save"));if(!0===k){var v=function(){var a=w;"keyup"===c&&(this.removeEventListener("change",v,{passive:!0,once:!0}),this.removeAttribute("data-isInit"),a=this.value.trim());var d=p.data("cid"),e=b.Models.Registry.lookup(d),f=h.extend(!0,{},e.get("styling"));
f||(f={});var g=h.extend(!0,{},f);f[l]=a;e.set({styling:f},{silent:!0});null!==u&&b.undoManager.push(d,u,p,"save",{bsettings:g,asettings:h.extend(!0,{},f)})};"keyup"===c?this.getAttribute("data-isInit")||(this.setAttribute("data-isInit",1),this.addEventListener("change",v,{passive:!0,once:!0})):v()}b.hasChanged=!0}else m&&(a=q.createElement("span"),a.className="tb_field_error_msg",a.textContent=ThemifyConstructor.label.errorId,this.parentNode.insertBefore(a,this.nextSibling),t!==r&&t.classList.add("tb_disable_save"));
...
if(!0===c){this.prevExpand="module"===t?g.getElementsByClassName("tb_module_action")[0]:d;if(this.prevExpand===r){this.clear();return}n.is_template_support?this.prevExpand.appendChild(k):this.prevExpand.insertAdjacentHTML("beforeend",k);this.prevExpand.setAttribute("id",this.el.id);this.prevExpand.style.top="";this.prevExpand.closest(".tb_action_wrap").classList.add("tb_clicked");!0===y&&"module"===t&&"visual"===b.mode&&(75>g.getBoundingClientRect().height&&(e=this.prevExpand.nextElementSibling,null!==
e&&e.classList.contains("tb_module_btn_plus")&&null!==e.offsetParent||(e=g.parentNode.nextElementSibling),null!==e&&(e=this.prevExpand.getBoundingClientRect().bottom-e.getBoundingClientRect().top,0<=e&&(this.prevExpand.style.top=this.prevExpand.offsetTop-e-2+"px"))),b.EdgeDrag.addEdges(f.get("mod_name"),f,g))}else("row"!==t||"row"===t&&null!==this.breadCrumbsPath.lightbox)&&this.setBreadCrumbs(g),this.el.className="tb_show_toolbar tb_"+t+"_action",e=q.createElement("div"),e.className="tb_action_label_wrap",
n.is_template_support?e.appendChild(k):e.insertAdjacentHTML("beforeend",k),"visual"===b.mode&&("module"===t?(k=f.get("mod_name"),this.el.className+=" tb_"+k+"_action",k=themifyBuilder.modules[k].name):(k=t,"row"===t&&(m=f.get("styling").row_anchor,m!==r&&(m=m.trim(),""!==m&&(k+=" #"+m)))),m=q.createElement("div"),m.className="tb_data_mod_name",m.textContent=k.charAt(0).toUpperCase()+k.slice(1),e.appendChild(m)),this.el.appendChild(e);!0!==y&&(g.classList.add("tb_element_clicked"),v.body[0].classList.add("tb_action_active"),
"visual"===b.mode&&b.EdgeDrag.addEdges("module"===t?f.get("mod_name"):t,f,g));if(!0===l&&(f.trigger("edit",a,d),!0===y||null!==this.disablePosition&&!1!==c&&!0===y))return;null===this.disablePosition&&(!1===c&&!0!==y?(f=a.pageX,y=a.pageY,"visual"!==b.mode&&(y=b.Instances.Builder[0].el.getBoundingClientRect(),f=a.clientX-y.left,y=a.clientY-y.top+30),this.setPosition(this.el,{left:f,top:y})):b.Utils.addViewPortClass(this.prevExpand))}}else!0!==y&&this.clear()}},setBreadCrumbs:function(a){for(;null!==
this.breadCrumbs.firstChild;)this.breadCrumbs.removeChild(this.breadCrumbs.firstChild);this.breadCrumbs.appendChild(this.getBreadCrumbs(a));null===this.el.firstChild?this.el.appendChild(this.breadCrumbs):this.el.insertBefore(this.breadCrumbs,this.el.firstChild)},getBreadCrumbPath:function(a,b){var c;b="rightClick"!==b?"lightbox":b;var d=null!==this.breadCrumbsPath[b]?this.breadCrumbsPath[b]:[];if(0<d.length)return d;if(r!==a)for((c=a.getAttribute("data-cid"))&&d.push(c);!a.classList.contains("module_row");)a=
a.parentNode,(c=a.getAttribute("data-cid"))&&d.push(c);return d},getBreadCrumbs:function(a,d){var c=this.getBreadCrumbPath(a,d),e=q.createDocumentFragment();if(r!==a)for(var f="rightClick"===d?a.dataset.cid:b.activeModel?b.activeModel.cid:b.ActionBar.cid,g=c.length-1;-1<g;--g){var h=q.createElement("li"),l=b.Models.Registry.lookup(c[g]),m=l.get("elType");h.textContent="column"===m?l.get("component_name"):"module"===m?l.get("mod_name"):m;h.className="tb_bread tb_bread_"+m;f===c[g]&&(h.className+=" tb_active_bc");
h.setAttribute("data-id",c[g]);e.appendChild(h)}return e},actions:function(a){var d=a.target;var c=d.tagName;if("keydown"===a.type){if("INPUT"!==c&&"TEXTAREA"!==c&&!themifyBuilder.disableShortcuts&&!n.Lightbox.$lightbox[0].contains(d)){var e=a.keyCode;c=q.getElementsByClassName("tb_element_clicked");var f=c.length;if(0<f){a.preventDefault();a.stopPropagation();var g=null,k=null,l=r,m=!0===a.ctrlKey||!0===a.metaKey;46===e||8===e?g="delete":!0===m&&(67===e?(g="copy",f=1):68===e?g="duplicate":86===e&&
(g="paste",!0===a.shiftKey&&(k="style")));1<f&&("delete"===g||"paste"===g)&&(l=!0,null!==b.activeModel&&n.Lightbox.$lightbox.is(":visible")&&ThemifyConstructor.saveComponent());for(d=f-1;-1<d;--d){var t=c[d];if(null===g){if(!0===m&&1===f&&(38===e||40===e)){var p=38===a.which?"up":"down";var u="up"===p?t.previousElementSibling:t.nextElementSibling;if(null!==u){if(t.classList.contains("module_row")){if(!u.classList.contains("module_row"))continue;var w=b.Instances.Builder[b.builderIndex].$el}else if(t.classList.contains("active_module")){if(!u.classList.contains("active_module"))continue;
w=h(t.parentNode.closest(".tb_holder"))}else continue;u&&(u=h(t),w.sortable("option","beforeStart")(null,null,{item:u}),w.sortable("option","start")(null,{item:u}),"up"===p?u.prev().before(u):u.next().after(u),w.sortable("option","update")({type:"sortupdate"},{item:u}),w.sortable("option","stop")(null,{item:u,helper:null}),!0!==this.isHoverMode&&t.classList.add("tb_element_clicked"))}}}else"delete"===g&&t.classList.contains("module_column")||(t=b.Models.Registry.lookup(h(t).closest("[data-cid]")[0].getAttribute("data-cid")),
t.trigger(g,a,k,l))}"delete"!==g&&!0===this.isHoverMode||this.clear()}}}else if(a.stopPropagation(),"click"===a.type&&null!==d.closest(".switch-wrapper"))d.classList.contains("toggle_switch")&&b.Models.Registry.lookup(h(d).closest("[data-cid]")[0].getAttribute("data-cid")).trigger("visibility",a,d);else if(a.preventDefault(),null!==this.cid&&("LI"===c||"SPAN"===c||"A"===c)&&(f=(e=d.classList.contains("tb_bread"))?d.getAttribute("data-id"):this.cid,p=null,t=b.Models.Registry.lookup(f),g=d.classList,
t))if(v.body[0].classList.remove("tb_component_menu_active"),!0===e)this.needClear=null,this.disablePosition=!0,q.getElementsByClassName("tb_element_cid_"+f)[0].click(),this.disablePosition=null,"visual"===b.mode&&(d=this.el.getBoundingClientRect(),d.right>=q.body.clientWidth&&this.setPosition(this.el,{left:d.left,top:this.el.offsetTop+55})),this.needClear=!0;else if(p=d.getAttribute("data-href"))for(a=d.parentNode.getElementsByTagName("li"),d=a.length-1;-1<d;--d)c=(t=a[d].getAttribute("data-href"))?
q.getElementById(t):null,e=a[d].classList.contains("selected"),a[d].classList.remove("selected"),null!==c&&c.classList.remove("selected"),t!==p||e||("tb_row_options"===t||"tb_rgrids"===t?this.gridMenu(c):"tb_roptions"===t&&0===c.children.length&&this.setRowOptions(c),c.classList.add("selected"),a[d].classList.add("selected"),b.Utils.addViewPortClass(c),v.body[0].classList.add("tb_component_menu_active"));else{if(g.contains("tb_edit")||g.contains("tb_styling")||g.contains("tb_visibility_component")||
g.contains("tb_swap"))p="edit";else if(g.contains("tb_duplicate"))p="duplicate";else if(g.contains("tb_save_component"))p="save";else if(g.contains("tb_delete"))p="delete";else if(g.contains("ti-import")||g.contains("ti-export"))p="importExport";else if(g.contains("tb_copy_component"))p="copy";else if(g.contains("tb_paste_component")||g.contains("tb_paste_style"))p="paste";else{if("LI"===c||"SPAN"===c||g.contains("tb_action_more")||g.contains("tb_inner_action_more")){a=d.closest("li");if(null===a)return;
e=a.parentNode;p=e.classList;t=p.contains("tb_grid_list")||p.contains("tb_column_alignment")||p.contains("tb_column_gutter")||p.contains("tb_column_direction")||p.contains("tb_column_height")||p.contains("grid_tabs");c=d.classList.contains("selected");e=e.children;if(t&&c)return;for(d=e.length-1;-1<d;--d)if(e[d].classList.remove("selected"),!1===t)for(f=e[d].getElementsByClassName("selected"),g=f.length-1;-1<g;--g)f[g].classList.remove("selected");c||(a.classList.add("selected"),v.body[0].classList.add("tb_component_menu_active"));
if(t)p.contains("tb_column_alignment")?this._columnAlignmentClicked(a):p.contains("tb_column_gutter")?this._gutterChange(a):p.contains("tb_column_direction")?this._columnDirectionClicked(a):p.contains("tb_column_height")?this._columnHeight(a):p.contains("grid_tabs")?this._switchGridTabs(a):p.contains("tb_grid_list")&&this._gridClicked(a);else{e=null!==this.prevExpand?this.prevExpand.children:this.el.getElementsByClassName("tb_action_label_wrap")[0].children;for(d=e.length-1;-1<d;--d)e[d].classList.remove("selected");
c||null!==this.prevExpand&&"column"!==this.type||(e=a.getElementsByTagName("ul")[0],e!==r&&b.Utils.addViewPortClass(e))}}return}if(!0!==this.isHoverMode)this.clear();else{var x=d.closest(".tb_action_more");null!==x&&(x=x.getElementsByTagName("ul")[0],x.style.display="none",setTimeout(function(){null!==x&&(x.style.display="")},100))}t.trigger(p,a,d)}},_switchGridTabs:function(a){b.ActionBar.disable=b.clearOnModeChange=!0;b.ActionBar.hoverCid=null;b.scrollTo=h(q.getElementsByClassName("tb_element_cid_"+
this.cid)[0]);ThemifyConstructor.lightboxSwitch(a.getAttribute("data-id"));"visual"!==b.mode&&this.gridMenu(a.closest(".tb_toolbar_tabs"))},_gridClicked:function(a){var d=h(a),c=d.data("grid"),e=this.type,f=h(".tb_element_cid_"+this.cid).first(),g=!1,k=b.activeBreakPoint,l="desktop"===k;a=n.clone(f.closest(".module_row"));g="subrow"===e;var m=f.find("."+e+"_inner").first();if(l){e=m;var t=d.data("col");e=e.add(h("#tb_rgrids"));t===r&&(t=1,d.data("col",t));for(k=6;0<k;--k)e.removeClass("col-count-"+
k);e.addClass("col-count-"+t);m.attr("data-basecol",t);l&&d.closest(".tb_grid_menu").find(".tb_grid_reposnive .tb_grid_list").each(function(){var a=h(this).find(".selected"),b=h(this).data("type"),c=a.data("col");c!==r&&(c>t||4===t&&3===c||4<=t&&4<=c&&t!=c)&&(a.removeClass("selected"),m.removeClass("tb_grid_classes col-count-"+m.attr("data-basecol")+" "+m.attr("data-col_"+b)).attr("data-col_"+b,""),h(this).closest(".tb_grid_list").find("."+b+"-auto").addClass("selected"))})}else return"-auto"!==c[0]?
(a="column"+c.join("-"),t=d.data("col"),3===t&&m.attr("data-basecol")>t&&(a+=" tb_3col"),m.removeClass(m.attr("data-col_tablet")+" "+m.attr("data-col_tablet_landscape")+" "+m.attr("data-col_mobile")).addClass(a+" tb_grid_classes col-count-"+m.attr("data-basecol")).attr("data-col_"+k,a)):m.removeClass("tb_grid_classes tb_3col col-count-"+m.attr("data-basecol")+" "+m.attr("data-col_"+k)).attr("data-col_"+k,""),"visual"===b.mode&&(h("body",u.document).height(q.body.scrollHeight),b.Utils.calculateHeight()),
b.Utils.setCompactMode(m.children(".module_column")),!1;d=m.children(".module_column");l=c.length;e="module_column"+(g?" sub_column":"")+" col";for(k=0;k<l;++k)f=d.eq(k),0<f.length?f.removeClass(b.Utils.gridClass.join(" ")).addClass(e+c[k]):b.Utils._addNewColumn({newclass:e+c[k],component:g?"sub-column":"column"},m[0]);l<m.children().length&&m.children(".module_column").eq(l-1).nextAll().each(function(){h(this).find(".tb_holder").first().children().appendTo(h(this).prev().find(".tb_holder").first());
h(this).remove()});c=m.children();c.removeClass("first last");m.hasClass("direction-rtl")?(c.last().addClass("first"),c.first().addClass("last")):(c.first().addClass("first"),c.last().addClass("last"));b.Utils.columnDrag(m,!0);f=m.closest(".module_row");b.hasChanged=!0;b.Mixins.Builder.updateModuleSort(f);b.undoManager.push(f.data("cid"),a,f,"row");v.body.triggerHandler("tb_grid_changed",[f])},_columnHeight:function(a){a=h(a).data("value");if(a!==r){var d=h(".tb_element_cid_"+this.cid).first(),c=
b.Models.Registry.lookup(this.cid),e=n.clone(d),d=d.find("."+this.type+"_inner").first();""===a?d.removeClass("col_auto_height"):d.addClass("col_auto_height");c.set({column_h:a},{silent:!0});b.undoManager.push(this.cid,e,h(".tb_element_cid_"+this.cid).first(),"row")}},_columnAlignmentClicked:function(a){a=h(a);if(a=a.data("alignment")){var d=h(".tb_element_cid_"+this.cid).first(),c=b.Models.Registry.lookup(this.cid),e=n.clone(d);d.find("."+this.type+"_inner").first().removeClass(c.get("column_alignment")).addClass(a);
c.set({column_alignment:a},{silent:!0});b.undoManager.push(this.cid,e,h(".tb_element_cid_"+this.cid).first(),"row")}},_columnDirectionClicked:function(a){a=h(a);if(a=a.data("dir")){var d=h(".tb_element_cid_"+this.cid).first().find("."+this.type+"_inner").first(),c=d.children(".module_column"),e=c.first(),c=c.last(),f=b.Models.Registry.lookup(this.cid),g={};g[b.activeBreakPoint+"_dir"]=a;f.set(g,{silent:!0});"rtl"===a?(e.removeClass("first").addClass("last"),c.removeClass("last").addClass("first"),
d.addClass("direction-rtl")):(e.removeClass("last").addClass("first"),c.removeClass("first").addClass("last"),d.removeClass("direction-rtl"));d.attr("data-"+b.activeBreakPoint+"_dir",a)}},_gutterChange:function(a){if(a=h(a).data("value")){var d=h(".tb_element_cid_"+this.cid).first(),c=b.Models.Registry.lookup(this.cid),e=c.get("gutter"),f=n.clone(d),d=d.find("."+this.type+"_inner").first();b.Utils.columnDrag(d,!1,e,a);d.removeClass(e).addClass(a);c.set({gutter:a},{silent:!0});b.undoManager.push(this.cid,
f,h(".tb_element_cid_"+this.cid).first(),"row")}},gridMenu:function(a){for(var d=b.activeBreakPoint,c="desktop"===d,e=b.Models.Registry.lookup(this.cid),f=e.get(d+"_dir"),g=e.get("column_alignment"),k=e.get("column_h"),e=e.get("gutter"),l=q.getElementsByClassName("tb_element_cid_"+this.cid)[0].getElementsByClassName(this.type+"_inner")[0],m=!0===c?r:l.getAttribute("data-col_"+d),n=l.children,p=n.length,u=[],l=0;l<p;++l)u.push(b.Utils._getColClass(n[l].className.split(" ")));n="tb_rgrids"===a.id?a:
h(a).find("#tb_rgrids")[0];for(l=6;-1<l;--l)n.classList.remove("col-count-"+l);n.classList.add("col-count-"+p);u="grid-layout-"+u.join("-");a=a.getElementsByClassName("tb_grid_"+d)[0];n=a.getElementsByClassName("tb_grid_list")[0].getElementsByTagName("li");m="-auto"!==m&&m?"grid-layout-"+m.replace(/column|tb_3col/ig,"").trim():!1;!1!==c||!1!==m&&1!==p||(m=d+"-auto");for(l=n.length-1;-1<l;--l)!0===c&&n[l].classList.contains(u)||!1===c&&n[l].classList.contains(m)?n[l].classList.add("selected"):n[l].classList.remove("selected");
if("ltr"!==f)for(n=a.getElementsByClassName("tb_column_direction")[0].getElementsByTagName("li"),l=n.length-1;-1<l;--l)n[l].getAttribute("data-dir")===f?n[l].classList.add("selected"):n[l].classList.remove("selected");if(!0===c){if("col_align_top"!==g||!0===F)for(d=a.getElementsByClassName("tb_column_alignment")[0].getElementsByTagName("li"),l=d.length-1;-1<l;--l)d[l].getAttribute("data-alignment")===g?d[l].classList.add("selected"):d[l].classList.remove("selected");if("gutter-default"!==e)for(g=
a.getElementsByClassName("tb_column_gutter")[0].getElementsByTagName("li"),l=g.length-1;-1<l;--l)g[l].getAttribute("data-value")===e?g[l].classList.add("selected"):g[l].classList.remove("selected");if(k)for(g=a.getElementsByClassName("tb_column_height")[0].getElementsByTagName("li"),l=g.length-1;-1<l;--l)g[l].getAttribute("data-value")==k?g[l].classList.add("selected"):g[l].classList.remove("selected")}},setRowOptions:function(a){var d=null,c=b.activeModel,e=ThemifyConstructor.component,f=b.Models.Registry.lookup(this.cid),
g=f.get("styling");g||(g={});null!==c&&(d="module"===b.activeModel.get("elType")?"mod_settings":"styling",d=b.activeModel.get(d));if(a.children[0]!==r)for(;a.firstChild;)a.removeChild(a.firstChild);ThemifyConstructor.values=g;ThemifyConstructor.component=this.type;b.activeModel=f;a.appendChild(ThemifyConstructor.create(ThemifyConstructor.data.row.setting.options.slice(0,6)));ThemifyConstructor.values=d;b.activeModel=c;ThemifyConstructor.component=e},clear:function(){if(null!==this.type){this.cid=
this.type=null;for(this.el.classList.remove("tb_show_toolbar");null!==this.el.firstChild;)this.el.removeChild(this.el.firstChild);if(null!==this.prevExpand&&this.prevExpand!==r){for(;null!==this.prevExpand.firstChild;)this.prevExpand.removeChild(this.prevExpand.firstChild);this.prevExpand.removeAttribute("id");this.prevExpand.closest(".tb_action_wrap").classList.remove("tb_clicked");this.prevExpand=null}this.clearSelected();v.body[0].classList.remove("tb_action_active");v.body[0].classList.remove("tb_component_menu_active")}},
clearSelected:function(){"visual"===b.mode&&b.EdgeDrag.clearEdges()},clearClicked:function(){for(var a=b.Instances.Builder[0].el.getElementsByClassName("tb_element_clicked"),d=a.length-1;-1<d;--d)a[d].classList.remove("tb_element_clicked")},setPosition:function(a,d){a.removeAttribute("data-top");var c=a.getBoundingClientRect();var e=c.width,f=c.height+40,g="visual"===b.mode?x.pageYOffset:b.toolbar.el.offsetTop+this.topH,k="visual"===b.mode?q.body:b.Instances.Builder[0].el,l=k.clientWidth;c=d.nodeType!==
r?h(d).offset():d;c.right=c.bottom="";c.left-=parseFloat(e/2);c.top-=f;c.left+e>l?(c.left="auto",c.right=10):0>c.left&&(c.left=30);c.top>k.clientHeight?"visual"!==b.mode&&(c.top="auto",c.bottom=50):g>c.top&&(a.dataset.top=!0,c.top+=2*f-25,"visual"!==b.mode&&(c.top-=f/2));for(var m in c)a.style[m]="auto"!==c[m]&&""!==c[m]?c[m]+"px":c[m]}};b.Forms.register_validator=function(a,b){this.Validators[a]=b};b.Forms.get_validator=function(a){return this.Validators[a]!==r?this.Validators[a]:this.Validators.not_empty};
b.Forms.register_validator("email",function(a){var b=/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;a=a.split(",");for(var c=a.length-1;-1<c;--c)if(!b.test(a[c]))return!1;return!0});b.Forms.register_validator("not_empty",function(a){return!(!a||""===a.trim())});b.GS={styles:{},initContent:!1,loadingPosts:!1,allLoaded:!1,el:null,dropdown:null,isShown:null,field:null,isGSPage:q.body.classList.contains("gs_post"),
activeGS:null,xhr:null,key:"global_styles",previousModel:null,liveInstance:null,init:function(){if(!0===this.isGSPage)if(u.document.body.classList.add("gs_post"),"visual"!==b.mode||!0===v.is_builder_loaded)this.openStylingPanel();else{var a=this;u.Themify.body.one("themify_builder_ready",function(b){a.openStylingPanel();a=null})}else null!==themifyBuilder.globalStyles&&(this.extend(this.styles,themifyBuilder.globalStyles),themifyBuilder.globalStyles=null)},extend:function(a,b){for(var c in b)b[c]!==
r&&(a[c]=b[c]);return a},openStylingPanel:function(){var a=function(){var d=themifyBuilder.globalStyleData.type,d=b.Models.Registry.lookup(b.Instances.Builder[b.builderIndex].el.getElementsByClassName(("row"===d||"column"===d||"subrow"===d?"module_":"module-")+d)[0].dataset.cid);d.set("styleClicked",{silent:!0});b.isPreview=!1;d.trigger("edit",null);b.isPreview=!0;v.body.one("themify_builder_save_data",a)};a();b.toolbar.el.getElementsByClassName("tb_toolbar_builder_preview")[0].click()},setCss:function(a,
d,c){"visual"===b.mode&&b.liveStylingInstance.setCss(a,d,c)},createCss:function(a,b,c){ThemifyStyles.GS={};return ThemifyStyles.createCss(a,b,c,this.styles)},findUsedItems:function(a){a=JSON.stringify(a);for(var b=/"global_styles":"(.*?)"/mg,c,e="";null!==(c=b.exec(a));)e+=" "+c[1].trim();e=e.trim();if(""!==e){e=h.unique(e.split(" "));a=[];for(b=e.length-1;-1<b;--b)this.styles[e[b]]!==r&&a.push(e[b]);return a}return!1},globalStylesHTML:function(){if(!0===this.isGSPage||null!==this.activeGS)return!1;
var a=q.createElement("div"),d=q.createElement("div"),c=q.createElement("span");this.isShown=null;this.field=ThemifyConstructor.hidden.render({id:b.GS.key,is_responsive:!1,value:ThemifyConstructor.values[b.GS.key],control:!1},ThemifyConstructor);a.className="tb_gs_container";if(this.field.value){for(var e=this.field.value.split(" "),f="",g=e.length-1;-1<g;--g)this.styles[e[g]]!==r&&(f+=" "+e[g]);f=f.trim();this.field.value=f}else this.field.value="";d.className="tb_gs_icon ti-brush-alt";d.addEventListener("click",
function(a){if(a.target.classList.contains("tb_gs_icon")){var c=this.el;if(c.classList.contains("tb_gs_dropdown_opened"))a.stopPropagation(),c.classList.remove("tb_gs_dropdown_action"),c.classList.remove("tb_gs_dropdown_opened");else{c.classList.add("tb_gs_dropdown_opened");c.classList.add("tb_gs_dropdown_action");var d=function(a){null===c||c.contains(a.target)||(q.removeEventListener("click",d,{passive:!0}),"visual"===b.mode&&u.document.removeEventListener("click",d,{passive:!0}),c.classList.remove("tb_gs_dropdown_action"),
c.classList.remove("tb_gs_dropdown_opened"),c=null)};q.addEventListener("mousedown",d,{passive:!0});"visual"===b.mode&&u.document.addEventListener("mousedown",d,{passive:!0})}}}.bind(this),{passive:!0});c.className="tb_gs_tooltip";c.textContent=themifyBuilder.i18n.gs;d.appendChild(c);a.appendChild(this.field);a.appendChild(d);this.el=a;""!==this.field.value&&(d=this.stylingOverlay(),null!==d&&a.appendChild(d));a.addEventListener("click",this.initClickEvent.bind(this));this.initContent=!1;a=null;return this.el},
...
b.insertAdjacentHTML("afterend",a);this.initContent=!0},createSelectedItem:function(a){var b=this.styles[a],c=q.createElement("div"),e=q.createElement("span"),f=q.createElement("span"),g=q.createElement("span");c.className="tb_selected_style";c.dataset.styleId=a;g.className="tb_gs_edit ti-pencil";c.appendChild(g);e.innerText=b.title;c.appendChild(e);f.className="tb_delete_gs ti-close";c.appendChild(f);return c},saveAs:function(){var a=this;n.LiteLightbox.prompt(themifyBuilder.i18n.enterGlobalStyleName,
function(b){if(null!==b){if(""===b)return alert(themifyBuilder.i18n.enterGlobalStyleName),a.saveAs(),!1;a.saveAsCallback(b)}})},saveAsCallback:function(a){ThemifyConstructor.setStylingValues(b.activeBreakPoint);var d=b.activeModel.get("elType"),c=this,e=b.Utils.clear(ThemifyConstructor.values);"module"===d&&(d=b.activeModel.get("mod_name"));delete e[this.key];h.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_save_as_new_global_style",tb_load_nonce:themifyBuilder.tb_load_nonce,
type:d,styles:e,title:a},beforeSend:function(){n.showLoader("show")},error:function(){n.showLoader("error")},success:function(a){n.showLoader("hide");"success"===a.status?(a=a.post_data,c.styles[a["class"]]=a,b.Utils.saveCss(b.Utils.clear(a.data),"",a.id),n.LiteLightbox.confirm(themifyBuilder.i18n.addSavedGS,function(d){if("yes"===d){c.isGSPage=!0;d=c.field.value;n.Lightbox.$lightbox[0].getElementsByClassName("reset-styling")[0].click();c.isGSPage=!1;d=a["class"]+" "+d;d=d.trim();c.field.value=d;
d=d.split(" ");var e=c.el.getElementsByClassName("tb_gs_selected_styles")[0];e.innerHTML="";for(var f=0,g=d.length;f<g;++f)e.appendChild(c.createSelectedItem(d[f]));b.GS.generateValues(null,d,!0);d=c.stylingOverlay();null!==d&&c.el.appendChild(d)}c.addItemToDropdown([a["class"]]);c=null},{buttons:{no:{label:ThemifyConstructor.label.no},yes:{label:ThemifyConstructor.label.y}}})):alert(a.msg)}})},"delete":function(a){if(null!==this.field){b.hasChanged=!0;var d=this.el.querySelector('.global_style_item[data-style-id="'+
a+'"]'),c=this.el.querySelector('.tb_selected_style[data-style-id="'+a+'"]');null!==d&&d.classList.remove("selected");null!==c&&c.parentNode.removeChild(c);d=this.field.value.trim();d=d.split(" ");d.splice(d.indexOf(a),1);this.field.value=d=d.join(" ");null!==b.ActionBar.contextMenu&&b.ActionBar.contextMenu.contains(this.field)?b.ActionBar.rightClickGS(a,d,!0):this.generateValues(a,d.split(" "),!0);return!0}},insert:function(a){if(null!==this.field){b.hasChanged=!0;null!==this.dropdown&&this.dropdown.querySelector('.global_style_item[data-style-id="'+
a+'"]').classList.add("selected");var d=this.createSelectedItem(a);this.el.getElementsByClassName("tb_gs_selected_styles")[0].appendChild(d);d=this.field.value+" "+a;this.field.value=d=d.trim();if(""!==d){var c=this.stylingOverlay();null!==c&&(this.el.classList.add("tb_gs_dropdown_action"),this.el.appendChild(c))}null!==b.ActionBar.contextMenu&&b.ActionBar.contextMenu.contains(this.field)?b.ActionBar.rightClickGS(a,d):this.generateValues(a,d.split(" "))}},search:function(){var a=this;this.el.querySelector("#global-style-search").addEventListener("input",
function(b){var c=b.target.value.toUpperCase(),d=this.el,f=function(){for(var a=d.getElementsByClassName("tb_gs_list")[0].getElementsByClassName("global_style_item"),b=a.length-1;-1<b;--b){var e=a[b].getElementsByClassName("global_style_title")[0];e&&(a[b].style.display=-1<e.innerHTML.toUpperCase().indexOf(c)?"":"none")}};null!==a.xhr&&(a.xhr.abort(),a.xhr=null);a.allLoaded||setTimeout(function(){a.loadMore(c,f)},100);f()}.bind(this),{passive:!0})},addItemToDropdown:function(a){if(null!==this.dropdown){for(var b=
q.createDocumentFragment(),c=this.field.value.split(" "),e=this.dropdown.getElementsByClassName("tb_no_gs_item")[0],f=0,g=a.length;f<g;++f){var h=this.styles[a[f]],l=q.createElement("div"),m=q.createElement("span"),n=q.createElement("span");l.className="global_style_item";l.className+=-1!==c.indexOf(a[f])?" selected":"";l.dataset.styleId=a[f];n.className="global_style_title";n.innerText=h.title;m.className="global_style_type";m.innerText=h.type;l.appendChild(n);l.appendChild(m);b.appendChild(l)}e.parentNode.insertBefore(b,
e)}},loadMore:function(a,b){var c=this,d=[];this.loadingPosts=!0;for(var f in this.styles)this.styles[f].id!==r&&d.push(this.styles[f].id);this.xhr=h.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{s:a,action:"tb_get_gs_posts",tb_load_nonce:themifyBuilder.tb_load_nonce,loaded:d},success:function(d){c.extend(c.styles,d);d=Object.keys(d);a||(c.allLoaded=10>d.length);c.addItemToDropdown(d);c.loadingPosts=!1;b&&b()}})},initDropdown:function(){this.dropdown=this.el.getElementsByClassName("tb_gs_list")[0];
var a=Object.keys(this.styles);this.addItemToDropdown(a);10>a.length&&!1===this.allLoaded&&this.loadMore();var a=new SimpleBar(this.dropdown),b=this.dropdown.getElementsByClassName("simplebar-content")[0],c=this.dropdown;b!==r&&(this.dropdown=b,c=a.getScrollElement());!1===this.allLoaded&&c.addEventListener("scroll",this.onScroll.bind(this),{passive:!0});this.search()},initClickEvent:function(a){!0!==this.initContent&&this.initHTML();var b=a.target,c=b.classList;if("LABEL"===b.nodeName||c.contains("tb_open_gs"))return!0;
"insert"===b.dataset.action?(a.preventDefault(),a.stopImmediatePropagation(),this.el.classList.remove("tb_gs_dropdown_action"),b.dataset.init===r&&(this.initDropdown(),b.dataset.init=!0)):c.contains("global_style_title")?(a.preventDefault(),a.stopImmediatePropagation(),this.insert(b.parentElement.dataset.styleId)):c.contains("tb_delete_gs")?(a.preventDefault(),a.stopImmediatePropagation(),this["delete"](b.parentElement.getAttribute("data-style-id"))):"save"===b.dataset.action?(a.preventDefault(),
a.stopImmediatePropagation(),this.saveAs()):c.contains("tb_gs_edit")&&this.liveEdit(b.parentNode.dataset.styleId)},onScroll:function(a){!1===this.allLoaded&&!1===this.loadingPosts&&(a=a.target,a=Math.max(a.scrollHeight-(a.scrollTop+a.offsetHeight),0),0<a&&200>=a&&(this.loadingPosts=!0,this.loadMore()))},updated:function(a,d,c,e){!1===this.isGSPage&&"visual"===b.mode&&"module"!==b.activeModel.get("elType")&&this.extraStyle(d,c,e)},setImport:function(a,b,c,e){if(!0!==e)for(var d in a)this.styles[d]!==
r&&delete a[d];if(0<Object.keys(a).length){this.loadingPosts=!0;var g=this;n.showLoader("show");h.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{onlySave:e?1:0,action:"tb_import_gs_posts_ajax",tb_load_nonce:themifyBuilder.tb_load_nonce,data:JSON.stringify(a)},error:function(){n.showLoader("error")},success:function(a){g.loadingPosts=!1;if(a)for(var d in a)g.styles[d]=a[d];b&&b(c);n.showLoader("hide");g=null}})}else b&&b(c)},generateValues:function(a,d,c){if(!0!==this.isGSPage&&
"visual"===b.mode){var e=b.activeModel.get("elType"),f=b.activeModel.get("element_id");"module"===e&&(e=b.activeModel.get("mod_name"));f={styling:ThemifyStyles.generateGSstyles(d,e,this.styles),element_id:f};ThemifyStyles.disableNestedSel=!0;null===this.liveInstance&&(this.liveInstance=b.createStyleInstance(),this.liveInstance.init(!0,!0));var e=this.createCss([f],e),g=this.liveInstance,h=[],l=b.activeBreakPoint;var m=g.prefix;var n=new RegExp(m,"g");ThemifyStyles.disableNestedSel=null;if(!0===c){var p=
ThemifyConstructor.breakpointsReverse;for(var q=p.length-1;-1<q;--q){b.activeBreakPoint=p[q];g.setMode(p[q],!0);var r=g.currentSheet;var u=r.cssRules?r.cssRules:r.rules;for(r=u.length-1;-1<r;--r)if(-1!==u[r].selectorText.indexOf(m)){c=u[r].selectorText.replace(/\,\s+/g,",").replace(n,"").split(",");var v=u[r].cssText.split("{")[1].split(";");if(-1!==c[0].indexOf(".tb_text_wrap"))for(var x=c.length-1;0<x;--x)-1!==c[x].indexOf(".tb_text_wrap")&&c.splice(x,1);for(x=v.length-2;-1<x;--x)g.setLiveStyle(v[x].trim().split(": ")[0].trim(),
"",c)}}}delete e.gs;for(q in e)if("fonts"===q||"cf_fonts"===q)for(var z in e[q])u=z,0<e[q][z].length&&(u+=":"+e[q][z].join(",")),h.push(u);else for(r in b.activeBreakPoint=q,g.setMode(q,!0),e[q])for(c=r.replace(/\,\s+/g,",").replace(n,"").split(","),x=0,v=e[q][r].length;x<v;++x){p=e[q][r][x].split(";");for(var A=p.length-2;-1<A;--A)""!==p[A]&&(m=p[A].split(":")[0],u=p[A].replace(m+":","").trim(),"background-image"===m&&-1!==p[A].indexOf("svg")&&-1!==p[A].indexOf("data:")&&(u+=";"+p[A+1]),g.setLiveStyle(m,
u,c))}0<h.length&&ThemifyConstructor.font_select.loadGoogleFonts(h.join("|"));b.activeBreakPoint=l;this.updated(a,e,f,d);this.liveInstance=null}},extraStyle:function(a,d,c){var e=null!==this.liveInstance?this.liveInstance:b.liveStylingInstance,f=e.prefix.length-1,g=0!==e.getComponentBgOverlay().length;c=e.$liveStyledElmt;var h=g,l={top:!1,bottom:!1,left:!1,right:!1},m=0;a:for(u in a)if("fonts"!==u&&"cf_fonts"!==u&&"gs"!==u)for(var n in a[u]){!1===h&&(h=-1!==n.indexOf("builder_row_cover",f));if(-1!==
n.indexOf("tb_row_frame",f))for(var p in l)if(!1===l[p]&&-1!==n.indexOf("tb_row_frame_"+p,f)){l[p]=!0;++m;break}if(!0===h&&4===m)break a}!1===g&&!0===h&&e.addOrRemoveComponentOverlay();if(0<m){a=q.createDocumentFragment();for(p in l)if(!0===l[p]&&0===c.children(".tb_row_frame_"+p).length){var u=q.createElement("div");u.className="tb_row_frame tb_row_frame_"+p;a.appendChild(u)}c.children(".tb_action_wrap").after(a)}(p=d.styling!==r?d.styling.background_type:"none")||(p="image");"image"===p&&"builder-parallax-scrolling"===
d.styling.background_repeat&&d.styling.background_image?(c[0].classList.add("builder-parallax-scrolling"),ThemifyBuilderModuleJs.backgroundScrolling(c)):(c[0].classList.remove("builder-parallax-scrolling"),c[0].style.backgroundPosition="","image"===p&&"builder-zoom-scrolling"===d.styling.background_repeat&&d.styling.background_image?(c[0].classList.add("builder-zoom-scrolling"),ThemifyBuilderModuleJs.backgroundZoom(c)):(c[0].classList.remove("builder-zoom-scrolling"),c[0].style.backgroundSize=""))},
liveEdit:function(a){var d={styleClicked:!0},c=!1;if(null===b.activeModel&&null!==b.ActionBar.contextMenu&&b.ActionBar.contextMenu.contains(this.field)){var e=b.Instances.Builder[b.builderIndex].el.getElementsByClassName("tb_element_clicked")[0];if(e===r)return;b.activeModel=b.Models.Registry.lookup(e.getAttribute("data-cid"));d.element_id=b.activeModel.get("element_id");this.previousModel=b.activeModel.cid;c=!0;b.Utils.scrollToDropped(e)}else null!==b.activeModel&&(this.previousModel=b.activeModel.cid,
d.element_id=b.activeModel.get("element_id"),ThemifyConstructor.saveComponent(!0));var f=this.styles[a],g=this,k=ThemifyConstructor.label.done,l="visual"===b.mode?h.extend(!0,{},b.liveStylingInstance):null,e=h.extend(!0,{},f.data[0]),m=f.type;this.activeGS=a;if("row"===m){delete e.cols;delete e.styling[this.key];var t=b.Views.init_row(e)}else"subrow"===m?(delete e.cols,delete e.styling[this.key],t=b.Views.init_subrow(e)):(delete e.styling,"column"===m?(delete e.cols[0].modules,delete e.cols[0].styling[this.key],
t=b.Views.init_column(e.cols[0])):(delete e.cols[0].styling,delete e.cols[0].modules[0].mod_settings[this.key],t=b.Views.init_module(e.cols[0].modules[0])));n.Lightbox.$lightbox[0].className+=" gs_post";ThemifyConstructor.label.done=ThemifyConstructor.label.s_s;b.ActionBar.hideContextMenu();n.Lightbox.$lightbox.one("themify_opened_lightbox.tb_gs_edit",function(){this.getElementsByClassName("current")[0].getElementsByClassName("tb_tooltip")[0].textContent=ThemifyConstructor.label.g_s+" - "+f.title});
t.model.set(d,{silent:!0});t.model.trigger("edit",null);var p=function(a){v.body.off("themify_builder_lightbox_close.tb_gs_edit themify_builder_save_component.tb_gs_edit");n.Lightbox.$lightbox[0].classList.remove("gs_post");ThemifyConstructor.label.done=k;t.model.destroy();"visual"===b.mode&&(l.prefix&&(b.liveStylingInstance=l,b.liveStylingInstance.$liveStyledElmt=h(q.querySelector(l.prefix)),null===g.previousModel||"row"!==m&&"column"!==m&&"subrow"!==m||(a=b.Models.Registry.lookup(g.previousModel))&&
"module"===a.get("elType")&&(b.liveStylingInstance.getComponentBgOverlay().remove(),b.liveStylingInstance.removeBgSlider(),b.liveStylingInstance.removeBgVideo(),b.liveStylingInstance.$liveStyledElmt.children(".tb_row_frame").remove(),b.liveStylingInstance.$liveStyledElmt[0].classList.remove("builder-zoom-scrolling"),b.liveStylingInstance.$liveStyledElmt[0].classList.remove("builder-zooming"),b.liveStylingInstance.$liveStyledElmt[0].classList.remove("builder-zoom-scrolling"))),l=g.liveInstance=null);
g.activeGS=null};v.body.one("themify_builder_lightbox_close.tb_gs_edit",function(a){console.lof("aaa");p();c?g.previousModel=null:g.reopenPreviousPanel()}).one("themify_builder_save_component.tb_gs_edit",function(a,d){var e=g.activeGS,f=g.styles[e],k=g.previousModel;delete ThemifyConstructor.values.cid;ThemifyConstructor.setStylingValues(b.activeBreakPoint);var l=ThemifyConstructor.values,q=b.activeModel;delete l[this.key];"row"===m||"subrow"===m?(f.data[0].styling=l,delete f.data[0].cols):(delete f.data[0].styling,
delete f.data[0].cols[0].grid_class,"column"===m?(delete f.data[0].cols[0].modules,f.data[0].cols[0].styling=l):(delete f.data[0].cols[0].styling,f.data[0].cols[0].modules[0].mod_settings=l));n.showLoader("show");b.Utils.saveCss(f.data,"",f.id);f.data=b.Utils.clear(f.data);g.styles[e].data=f.data;g.activeGS=null;g.previousModel=null;if("visual"===b.mode&&b.hasChanged){var l=b.Models.Registry.items,t;for(t in l){var u="module"===l[t].get("elType")?l[t].get("mod_settings"):l[t].get("styling");u[g.key]!==
r&&""!==u[g.key]&&-1!==u[g.key].indexOf(e)&&(b.activeModel=l[t],g.generateValues(e,u[g.key].split(" "),!0))}g.liveInstance=null}b.activeModel=q;g.previousModel=k;console.log("ddd");p(!0);b.hasChanged=!1;h.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_update_global_style",tb_load_nonce:themifyBuilder.tb_load_nonce,data:f.data,id:f.id},error:function(){n.showLoader("error")},success:function(){d||c?g.previousModel=null:g.reopenPreviousPanel();g=null;n.showLoader("hide")}});
f=null})},reopenPreviousPanel:function(a){r!==a?a.model.trigger("edit",a.e,a.target):null!==this.previousModel&&(a=b.Models.Registry.lookup(this.previousModel),null!==a&&(a.set({styleClicked:!0},{silent:!0}),a.trigger("edit",null)),this.previousModel=null)},stylingOverlay:function(){if(null===this.isShown&&null!==b.activeModel&&(null===this.el.parentNode||!this.el.parentNode.classList.contains("tb_inline_gs_show"))){this.isShown=!0;var a=q.createElement("div"),d=q.createElement("p"),c=function(a){a.preventDefault();
